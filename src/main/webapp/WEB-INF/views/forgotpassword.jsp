...
<body>
    ...
    <main class="login-body" data-vide-bg="assets/img/login-bg.mp4">
        <form class="form-default" action="sendotp" method="POST">
            <div class="login-form">
                <div class="logo-login">
                    <a href="index"><img src="assets/img/logo/loder.png" alt=""></a>
                </div>
                <h2>Forgot Password</h2>
                <p style="color:#ccc; font-size:14px; margin-bottom:20px;">Enter your registered email address. We'll send you an OTP.</p>
                ...
                <a href="login" class="forget">Back to Login</a>
            </div>
        </form>
    </main>
