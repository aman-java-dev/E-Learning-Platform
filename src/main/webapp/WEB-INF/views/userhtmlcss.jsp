...
<head>
    ...
    <title>HTML/CSS | Education</title>
                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-11 col-md-12">
                                <div class="hero__caption hero__caption2">
                                    <h1 data-animation="bounceIn" data-delay="0.2s">HTML, CSS & Bootstrap Web Design</h1>
                                    <!-- breadcrumb Start-->
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-7 col-lg-8">
                        <div class="section-tittle text-center mb-55">
                            <h2>HTML/CSS  Questions & Answers</h2>
                        </div>
                    </div>
                </div>
        ...
        <div class="row justify-content-center">
                    <div class="col-xl-12">
                        <div class="section-tittle text-center mt-20">
                            <a href="htmlcssquiz" class="border-btn">Start Quiz Now</a>
                        </div>
                    </div>
                </div>
</div>
